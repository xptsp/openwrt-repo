...
SCRIPT="$HOME/Compile/openwrt_24.10_x86/scripts/ipkg-make-index.sh"
KEY="$HOME/Compile/openWrtUsign.key"

# Update the files necessary for the repo:
MKHASH="$HOME/Compile/openwrt_24.10_x86/staging_dir/host/bin/mkhash" $SCRIPT . 2>/dev/null > Packages.manifest
